...
<html lang="ja">
    <head>
        ...
        <meta charset="utf-8" name="viewport"
              content="width=320,
                       ...
                       maximum-scale=2.0,
                       user-scalable=yes" />
        <link rel="stylesheet" href="style.css?202107270110" />
    ...
    <body onload="brython()"> 
        ...
        <div class="dot"></div><p>本ツールは <a href="https://jp.heroku.com/what">heroku</a> の無料プラットフォームで動作しており、<s>毎月550時間までサーバを利用できます。ほぼ大丈夫ですが、この550時間を超えてしまった場合は一時的に本ツールを利用できなくなる場合がありますのでご了承ください。</s></p>
        <div class="dot"></div><p><s>本ツールは無料サーバを利用しているため、初回アクセス時にサーバを立ち上げる時間がかかります。よって、初回アクセス時にうまく接続が安定しない場合はリロードするか10秒ほど待つとうまく接続されます。</s></p>
