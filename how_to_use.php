...
<html lang="ja">
    ...
    <body onload="brython()"> 
        ...
        <div class="dot"></div><p>まず、URL 欄に「調整さん」のイベント URL を入力します。トップページの「<a href="https://chouseisan.com/">調整さん</a>」のリンクへ行き、イベント履歴から URL をコピペするのがオススメです。2 回目以降は前回入力した URL が自動で入力されます。</p>
