...
<html lang="ja">
    ...
    <body onload="brython(); set_url()">
        <div class="container">
            ...
            <p>本ツールは <a href="https://jp.heroku.com/what">Heroku</a> の無料プラットフォームで動作しており、毎月550時間まで利用可能です。(ほぼ大丈夫ですが)これをを超えた場合は本ツールを一時的に利用できなくなる場合があります。</p>
            ...
            <script type="text/javascript">
                popup_update4("notification_update4", true);
